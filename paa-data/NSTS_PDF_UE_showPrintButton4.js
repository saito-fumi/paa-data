...
function userEventBeforeLoad(type, form, request)
{
	...
	{
		var intRecordTypeID = nlapiGetContext().getSetting('SCRIPT', 'custscript_ue_applies_to_record_type4');
		var intHTMLTemplateRecordID = nlapiGetContext().getSetting('SCRIPT', 'custscript_ue_html_template_record4');
		var strExistFileFieldID = nlapiGetContext().getSetting('SCRIPT', 'custscript_ue_exist_file_id4');
		var intTrxnForm = '';
		var intSubsidiaryID = '';
		var intReturnTypeID = '';
