...
function userEventBeforeLoad(type, form, request)
{
	...
	{
		var intRecordTypeID = nlapiGetContext().getSetting('SCRIPT', 'custscript_ue_applies_to_record_type_3');
		var intHTMLTemplateRecordID = nlapiGetContext().getSetting('SCRIPT', 'custscript_ue_html_template_record_3');
		var strExistFileFieldID = nlapiGetContext().getSetting('SCRIPT', 'custscript_ue_exist_file_id_3');
		var intTrxnForm = '';
		var intSubsidiaryID = '';
		var intReturnTypeID = '';
...
function userEventAfterSubmit(type)
{
	...
	try
	{
		...
		{
			var scriptParamTransactionId = nlapiGetContext().getSetting('SCRIPT', 'custscript_ue_html_template_record_3');// Function.getDefaultHTMLTemplate(nlapiGetRecordType());
