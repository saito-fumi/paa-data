...
function userEventBeforeLoad(type, form, request)
{
	...
	{
		var intRecordTypeID = nlapiGetContext().getSetting('SCRIPT', 'custscript_ue_applies_to_record_type3');
		var intHTMLTemplateRecordID = nlapiGetContext().getSetting('SCRIPT', 'custscript_ue_html_template_record3');
		var strExistFileFieldID = nlapiGetContext().getSetting('SCRIPT', 'custscript_ue_exist_file_id3');
		var intTrxnForm = '';
		var intSubsidiaryID = '';
		var intReturnTypeID = '';
